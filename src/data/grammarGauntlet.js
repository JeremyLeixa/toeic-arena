...
export var RELATIVE_WEAVER = [
  ...
  {id:"rw25",s:"Companies _____ invest in R&D tend to outperform competitors.",o:["who","which","whose","where"],c:1,type:"defining_subject_thing",x:"Organisations (companies) + sujet → which. 'who' réservé aux personnes ; 'where' réservé aux lieux."},
  ...
  {id:"rw41",s:"An approach _____ focuses on results outperforms one focused on process.",o:["who","which","whose","where"],c:1,type:"defining_subject_thing",x:"Chose (approach) + sujet → which. 'who' réservé aux personnes ; 'where' réservé aux lieux."},
  ...
  {id:"rw46",s:"People _____ early often get the best seats.",o:["arriving","who arriving","arrive","arrived"],c:0,type:"reduced_relative_active",x:"Relative réduite active = participe présent (V-ing). 'who arriving' est agrammatical ; 'arrive' / 'arrived' transformeraient la phrase en deux propositions principales."},
  ...
  {id:"rw57",s:"We documented all _____ was discussed at the board meeting.",o:["who","whom","that","where"],c:2,type:"defining_after_all",x:"Après 'all', 'everything', 'anything' référant à des choses : 'that' est la forme standard. 'who/whom' réservés aux personnes."},
  {id:"rw58",s:"It's the best decision _____ we've ever made.",o:["who","whom","that","where"],c:2,type:"defining_after_superlative",x:"Après un superlatif ('the best') + chose : 'that' est la forme privilégiée. 'who/whom' réservés aux personnes ; 'where' réservé aux lieux."},
