...
```
91 achievements (incl. 25 Gauntlet, 4 Word Tavern, 4 Duel, 4 Modal Council, 4 Mimic Hunt, 4 Nine to Five, 4 Jet Lag, 4 Front Desk, 4 Opening Night). `check` is a predicate function on student profile.
