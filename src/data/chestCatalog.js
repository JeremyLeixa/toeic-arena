// Données pures des coffres et de la boutique (catalogues, tables de tirage, pickRewards), sorties de
// src/data/chests.js le 2026-09-24 SANS modification : chests.js importe Supabase, ce module non. Il se charge
// donc en Node (tests, scripts/gen-economy-sql.mjs qui génère les catalogues côté serveur). chests.js les
// ré-exporte : les importateurs existants ne changent pas.
