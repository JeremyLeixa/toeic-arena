...
export function renderRoute(c){
  ...
  if(sp==="tavern"){if(!lastSession)playBGM("bgm_tavern");return pg(<WordTavern u={u} nav={nav} done={function(sc,tot,xp,mistakes){stopBGM();return miniSession(sc,tot,xp,mistakes);}} session={lastSession} closeSession={closeSession} replaySession={replaySession} resetCard={function(c){sv(c);}} back={function(){stopBGM();sSP(null);sT("games");}}/>);}
  ...
  if(sp==="mimic"){if(!lastSession)playBGM("bgm_clue");return pg(<MimicHunt session={lastSession} closeSession={closeSession} replaySession={replaySession} done={function(sc,tot,xp,mistakes,extra){stopBGM();return miniSession(sc,tot,xp,mistakes,extra);}} back={function(){stopBGM();sSP(null);sT("games");}}/>);}
