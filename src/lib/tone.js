// Pur, sans import, requérable en Node. Couleurs de signal codées en dur dans les données (ligues :
// data/leagues.js, titres et raretés : data/chests.js TITLES, RARITIES). Claires, pensées pour le
// fond sombre : en mode clair elles se délavent (Gold #ffd700 à 1,07:1 sur --bg3, Aldric's Chosen
// #e8d4a8 à 1,11:1, Legendary #ffc020 à 1,25:1).
//
...
// de ligue, de titre et de rareté.
//
