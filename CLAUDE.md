...
- **`TreasureChestSvg tier`** (0 Novice bois et corde · 1 Warrior acier bleui · 2 Champion bronze runique · 3 Legendary obsidienne et or) : même SVG pour le toast et le modal, calques `chx-lid/chx-lid-int/chx-mouth/chx-seam/chx-lock` animés par le modal.
