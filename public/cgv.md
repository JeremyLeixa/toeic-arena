...
> - Valider les clauses limitatives de responsabilité
> - Confirmer l'adhésion au médiateur de la consommation approprié
> - Adapter les mentions selon ton statut juridique final (EI / SASU / micro-entreprise)
...
En cas de contradiction, les CGV prévalent pour les aspects contractuels et tarifaires.
...
- **Formule Freemium (gratuite)** : accès limité à un ensemble restreint de modules et de contenus, avec fonctionnalités restreintes.
- **Formule Premium (payante)** : accès à l'intégralité des modules, tests blancs, Boss Test, Endless Arena, et fonctionnalités avancées telles que listées sur la page de souscription.
...
La souscription à un abonnement Premium implique l'acceptation pleine, entière et sans réserve des présentes CGV par le Client. Le Client reconnaît avoir pris connaissance des CGV préalablement à sa commande et déclare les accepter en cochant la case prévue à cet effet lors du processus de paiement.

Le Client déclare être âgé de 15 ans révolus. Si le Client est mineur, il garantit avoir obtenu l'autorisation préalable de son représentant légal pour souscrire au Service.
...
En cas de dépassement des seuils de franchise prévus par la loi, l'Éditeur informera préalablement les Clients de l'application de la TVA sur les prix, conformément à l'article 6.3.

### 6.3 Modification des prix
L'Éditeur se réserve le droit de modifier ses prix à tout moment. Les modifications tarifaires ne s'appliqueront qu'aux nouvelles souscriptions ou aux renouvellements d'abonnement, après information préalable du Client au moins trente (30) jours avant la date d'application, par email. Le Client peut résilier son abonnement avant la date d'application du nouveau tarif s'il ne l'accepte pas (cf. article 10).
...
Le paiement est traité par **Stripe Payments Europe, Limited** (société de droit irlandais enregistrée à la Banque Centrale d'Irlande), prestataire de services de paiement agréé, qui assure la sécurité, la confidentialité et l'intégrité des transactions.

### 7.2 Moyens de paiement acceptés
Cartes bancaires Visa, Mastercard, American Express, ainsi que tout moyen de paiement accepté par Stripe au moment de la souscription (Apple Pay, Google Pay, SEPA Direct Debit, selon disponibilité).
...
### 9.1 Principe
Conformément à l'article L. 221-18 du Code de la consommation, le Client consommateur dispose en principe d'un délai de **quatorze (14) jours** à compter de la conclusion du contrat pour exercer son droit de rétractation, sans avoir à justifier de motifs ni à payer de pénalités.
...
Si le Client n'a pas expressément renoncé à son droit de rétractation selon les modalités ci-dessus, il peut exercer ce droit dans un délai de quatorze (14) jours à compter de la souscription, en adressant une demande non ambiguë par email à l'adresse leixa.formation@gmail.com. Le remboursement interviendra dans un délai de quatorze (14) jours à compter de la réception de la demande, par le même moyen de paiement que celui utilisé pour la transaction initiale.
...
L'ensemble des éléments du Service (textes, images, sons, code, bases de données de questions, design, logo, mises en page) est la propriété exclusive de l'Éditeur ou de ses partenaires, et est protégé par le droit d'auteur, le droit des bases de données et, le cas échéant, le droit des marques.
...
Toute reproduction, représentation, diffusion, ou exploitation commerciale, totale ou partielle, du Service ou de son contenu, par quelque procédé que ce soit, sans l'autorisation écrite préalable de l'Éditeur, est strictement interdite et susceptible de constituer une contrefaçon sanctionnée par les articles L. 335-2 et suivants du Code de la propriété intellectuelle.

---

## Article 13 — Protection des données personnelles

Le traitement des données personnelles du Client est régi par la **Politique de Confidentialité**, accessible depuis l'application, conforme au Règlement Général sur la Protection des Données (RGPD — UE 2016/679) et à la loi « Informatique et Libertés » n° 78-17 du 6 janvier 1978 modifiée.

La souscription à un abonnement Premium implique le traitement de données supplémentaires (identifiant client Stripe, statut et historique d'abonnement, factures). Ces données sont conservées pour la durée de la relation contractuelle et, au-delà, selon les obligations légales applicables (notamment **dix (10) ans** pour les pièces comptables en application de l'article L. 123-22 du Code de commerce).
...
L'Éditeur est tenu à une obligation de moyens dans la fourniture du Service. Il met tout en œuvre pour assurer un fonctionnement optimal mais ne garantit pas l'absence d'erreurs, de bugs, d'interruptions, ni l'adéquation parfaite du Service à un objectif spécifique du Client, notamment l'obtention d'un score TOEIC particulier.

### 14.2 Nature pédagogique du Service
Le Service est un **outil d'entraînement**. Le score TOEIC estimé affiché dans l'application est indicatif et basé sur des modèles statistiques propres à l'Éditeur. Il ne saurait se substituer au test TOEIC officiel administré par ETS, ni garantir le résultat obtenu lors d'un test officiel.
...
### 14.5 Exclusions
Les limitations ci-dessus ne s'appliquent pas en cas de faute lourde, dol ou faute intentionnelle de l'Éditeur, ni à la réparation des dommages corporels, conformément au droit applicable.

---

## Article 15 — Force majeure

La responsabilité de l'Éditeur ne pourra être engagée en cas de non-exécution ou de retard dans l'exécution de ses obligations résultant d'un cas de force majeure au sens de l'article 1218 du Code civil, incluant notamment, sans s'y limiter : catastrophes naturelles, pandémies, grèves, guerres, actes terroristes, défaillances de réseaux de télécommunication ou d'infrastructures techniques tierces (hébergeur, prestataire de paiement).

---

## Article 16 — Service client et réclamations

Pour toute question, demande d'information ou réclamation, le Client peut contacter le service client :

- **Email** : leixa.formation@gmail.com
- **Délai de réponse indicatif** : cinq (5) jours ouvrés

En cas de réclamation écrite, l'Éditeur s'engage à accuser réception dans les meilleurs délais et à apporter une réponse motivée dans un délai maximal de trente (30) jours.
...
L'Éditeur se réserve le droit de modifier les CGV à tout moment pour tenir compte d'évolutions légales, réglementaires, jurisprudentielles, techniques ou commerciales.

Les nouvelles CGV sont notifiées par email au Client au moins **trente (30) jours** avant leur entrée en vigueur. Si le Client n'accepte pas les nouvelles CGV, il peut résilier son abonnement sans frais avant leur date d'application. À défaut de résiliation, les nouvelles CGV s'appliquent à compter de leur date d'entrée en vigueur.
...
## Article 19 — Intégralité, nullité, non-renonciation
...
**Fin des Conditions Générales de Vente — Version 1.0**
