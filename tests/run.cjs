...
const SUITE = [
  ...
  ['check_office_day.cjs',         'Nine to Five : chaque journée tirée tient dans 9:00-17:00, sans doublon, au format du grade, horloge clémente en bas, réputation bornée'],
  ...
  ['check_honors.cjs',            'le parchemin de fin : Darics regroupés par source, trophées repliés au-delà de 4, sans rien perdre'],
  ...
  ['check_rgpd_erasure.cjs',        'l\'effacement RGPD purge toutes les tables de l\'élève (élève et formateur) et un refus ne se fait pas passer pour un succes'],
  ['check_mock_coverage.cjs',       'le Mock 3 et le Boss comptent partout où les Mocks 1 et 2 comptent (estimateur, trophée, coffre)'],
